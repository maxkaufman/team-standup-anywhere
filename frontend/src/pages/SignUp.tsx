...
export default function SignUp() {
  ...
  const [signUpMutation, { loading }] = useMutation(SIGN_UP_MUTATION, {
    onCompleted: (data) => {
      login(data.signUp.token, data.signUp.refreshToken, data.signUp.user);
      navigate('/dashboard');
    },
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    setError('');
    signUpMutation({ variables: { input: { name, email, password } } });
  };
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-lg p-8">
          ...
          <p className="text-gray-500 text-center mb-8">Get started with TeamPulse</p>
